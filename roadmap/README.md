...
- [x] Company identity and administrative continuity
- [x] Cost guardrails
...
- prevents an onboarding failure;
- reduces time from credits to a correctly configured environment;
- helps a team choose a simpler platform;
